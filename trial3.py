...
'''
The coefficients of the polynomial, represented as a comma-separated list of integers. The coefficients are ordered lexicographically, with the first coefficient corresponding to the monomial where all variables are set to 0, the second coefficient corresponding to the monomial where only the first variable is set to 1, the third coefficient corresponding to the monomial where only the second variable is set to 1, and so on. The last coefficient corresponds to the monomial where all variables are set to 1.
Number of variables: 3
Degree of polynomial: 2
Coefficients of polynomial: 1,0,1,1,0,1,0,1
Partial assignment: x1=0, x2=1, x3=0
